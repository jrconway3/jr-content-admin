...
(function($) {
    ...
    function updateRepeaterIndexes($repeater) {
        $repeater.find('.jr-content-admin-repeater-row').each(function(index) {
    ...
    $(function() {
        $(document).on('click', '.jr-content-admin-add-row', function() {
        ...
        $(document).on('click', '.jr-content-admin-remove-row', function() {
            var $repeater = $(this).closest('.jr-content-admin-repeater');
            $(this).closest('.jr-content-admin-repeater-row').remove();
            updateRepeaterIndexes($repeater);
        });

        $(document).on('click', '.jr-content-admin-move-up', function() {
        ...
        $(document).on('click', '.jr-content-admin-move-down', function() {
            var $row = $(this).closest('.jr-content-admin-repeater-row');
        ...
        $(document).on('click', '.jr-content-admin-select-image', function(event) {
            event.preventDefault();
            openMediaFrame($(this));
        });

        $(document).on('click', '.jr-content-admin-clear-image', function(event) {
            event.preventDefault();
            var $row = $(this).closest('.jr-content-admin-repeater-row');
